...
from .views import (
        reportview,reportupdate,adminpage,create_certificate,\
        change_status,personaldetail,project,\
        register_user,login,confirm_logout_user,register_activation,
        register_token,forgot_password,forgot_password_confirm,\
