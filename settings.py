...
if DEBUG == True:
    DATABASES = {
        'default': {
            ...
            'NAME':'aktqzzhd',
            'USER':'aktqzzhd',
            'PASSWORD':'E1m5Zqh2RfyXMXBceTen--GX69gINzp7',
...
if DEBUG:
    ...
    TOKEN_URL = 'http://localhost:8000/certificate/register-token'
    FP_TOKEN_URL = 'http://localhost:8000/certificate/forgot-password-token'
else:
    EMAIL_HOST = 'email-smtp.us-west-2.amazonaws.com'
    EMAIL_PORT = 587
    EMAIL_HOST_USER = awsses.username
    EMAIL_HOST_PASSWORD = awsses.password
    EMAIL_USE_TLS = True
